...
def test_alpine_filtering_updates_visible_rows(app_page: Page):
    ...
    expect(app_page.locator('tbody tr:has-text("CASE_COMPLETE")')).to_have_count(
        EXPECTED_COMPLETE_PAIR_ROWS
    )
...
def test_incomplete_pairs_render_single_row(app_page: Page):
    ...
    expect(app_page.locator('tr[data-case-id="CASE_INCOMPLETE"]')).to_have_count(
...
def test_checkbox_state_reflects_database(app_page: Page):
    ...
    complete_checkbox = app_page.locator(
        'tr[data-case-id="CASE_COMPLETE"] input[type="checkbox"]'
    )
    expect(complete_checkbox).not_to_be_checked()

    # CASE_DONE should be checked (is_done=True)
    done_checkbox = app_page.locator(
        'tr[data-case-id="CASE_DONE"] input[type="checkbox"]'
    )
...
def test_complete_indicator_visual_state(app_page: Page):
    ...
    complete_indicator = app_page.locator(
        'tr[data-case-id="CASE_COMPLETE"].genomic .complete-indicator'
    )
    ...
    incomplete_indicator = app_page.locator(
        'tr[data-case-id="CASE_INCOMPLETE"] .complete-indicator'
    )
...
def test_valid_indicator_visual_state(app_page: Page):
    ...
    valid_indicator = app_page.locator(
        'tr[data-case-id="CASE_COMPLETE"].genomic .valid-indicator'
    )
    ...
    invalid_indicator = app_page.locator(
        'tr[data-case-id="CASE_INVALID"].genomic .valid-indicator'
    )
