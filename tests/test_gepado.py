...
from mvh_copy_mb.gepado import (
    GepadoClient,
    GepadoRecord,
    create_gepado_client_from_env,
    map_data_type_to_fields,
    compare_record_data,
    validate_and_update_record,
...
class TestEnvironmentConfiguration:
    ...
    def test_property_environment_configuration_usage(
        self, host, database, username, password
    ):
        """
...
class TestDataFieldMapping:
    ...
    def test_compare_record_data_empty_fields(self):
        ...
        record = GepadoRecord(
            hl7_case_id="12345", vng=None, ibe_g=None, mv_servicedate_g=None
        )
    ...
    def test_compare_record_data_matching_fields(self):
        ...
        record = GepadoRecord(
            hl7_case_id="12345", vng="VN123", ibe_g="IBE123", mv_servicedate_g=None
        )
        updates, mismatches = compare_record_data(record, "VN123", "IBE123", "G")
    ...
    def test_compare_record_data_mismatched_fields(self):
        ...
        record = GepadoRecord(
            hl7_case_id="12345", vng="OLD_VN", ibe_g="OLD_IBE", mv_servicedate_g=None
        )
    ...
    def test_property_data_field_mapping_and_updates(
        self, art_der_daten, vorgangsnummer, ibe_string
    ):
        """
        ...
        **Validates: Requirements 4.3, 4.4, 4.5, 4.6**
        ...
        updates, mismatches = compare_record_data(
            empty_record, vorgangsnummer, ibe_string, art_der_daten
        )
        ...
        updates, mismatches = compare_record_data(
            populated_record, vorgangsnummer, ibe_string, art_der_daten
        )
    ...
    def test_property_update_operation_idempotence(
        self, art_der_daten, vorgangsnummer, ibe_string
    ):
        """
        ...
        **Validates: Requirements 4.3, 4.4, 4.5, 4.6**
        ...
        updates1, mismatches1 = compare_record_data(
            empty_record, vorgangsnummer, ibe_string, art_der_daten
        )
        ...
        updates2, mismatches2 = compare_record_data(
            populated_record, vorgangsnummer, ibe_string, art_der_daten
        )
        ...
        updates3, mismatches3 = compare_record_data(
            populated_record, vorgangsnummer, ibe_string, art_der_daten
        )
    ...
    def test_property_record_processing_filter(self, ergebnis_qc, typ_der_meldung):
        ...
        **Validates: Requirements 4.1, 4.2**
        ...
        assert result == expected_result, (
            f"Filter failed for QC='{ergebnis_qc}', Typ='{typ_der_meldung}': expected {expected_result}, got {result}"
        )
...
class TestComprehensiveLogging:
    ...
    def test_property_comprehensive_logging_behavior(
        self,
        hl7_case_id,
        vorgangsnummer,
        ibe_string,
        ...
        try:
            ...
            if ergebnis_qc == "1" and typ_der_meldung == "0":
                ...
                assert hl7_case_id in log_output, (
                    f"HL7 case ID {hl7_case_id} should be logged"
                )
                ...
                if result:
                    ...
                    assert any(
                        ...
                        for keyword in ["successfully", "updated", "passes"]
                    ), "Should log success operations"
                ...
                assert (
                    "skipping" in log_output.lower() or "warning" in log_output.lower()
                ), "Should log filtering decisions"
...
class TestGepadoServiceDateIntegration:
    ...
    def test_property_gepado_clinical_data_update_inclusion(
        self, hl7_case_id, output_date
    ):
        """
        ...
        **Validates: Requirements 3.1**
        ...
        expected_updates = {
            "vnk": "VN123",
            "ibe_k": "IBE123",
            "mv_servicedate_k": expected_date_str,
        }
    ...
    def test_property_gepado_genetic_data_update_inclusion(
        self, hl7_case_id, output_date
    ):
        """
        ...
        **Validates: Requirements 3.2**
        ...
        expected_updates = {
            "vng": "VN123",
            "ibe_g": "IBE123",
            "mv_servicedate_g": expected_date_str,
        }
        mock_client.update_record.assert_called_once_with(hl7_case_id, expected_updates)
    ...
    def test_property_gepado_clinical_empty_field_updates(
        self, hl7_case_id, output_date
    ):
        """
    ...
    def test_property_gepado_genetic_empty_field_updates(
        self, hl7_case_id, output_date
    ):
        """
        ...
        **Validates: Requirements 3.3**
        ...
        try:
            ...
            mock_record = GepadoRecord(
                ...
                ibe_g="IBE123",
                mv_servicedate_k=None,
                mv_servicedate_g=existing_date,
            )
    ...
    def test_property_gepado_comparison_validation(
        self, hl7_case_id, vorgangsnummer, ibe_string, art_der_daten, output_date
    ):
        """
        ...
        **Validates: Requirements 5.4**
        ...
        vn_field, ibe_field, servicedate_field = map_data_type_to_fields(art_der_daten)
        mock_record = GepadoRecord(
            hl7_case_id=hl7_case_id, mv_servicedate_k=None, mv_servicedate_g=None
        )
...
class TestValidateAndUpdateRecord:
    ...
    def test_processes_valid_record_with_updates(self, mock_client_class):
        ...
        mock_client.update_record.assert_called_once_with(
            "hl7_123", {"vng": "VN123", "ibe_g": "IBE123"}
        )
    ...
    def test_property_gepado_clinical_conflict_detection(
        self, hl7_case_id, existing_date, new_date
    ):
        """
        ...
        **Validates: Requirements 3.5**
        ...
        try:
            ...
            mock_record = GepadoRecord(
                ...
                vnk="VN123",
                ibe_k="IBE123",
                mv_servicedate_k=existing_date,
                mv_servicedate_g=None,
            )
    ...
    def test_property_gepado_genetic_conflict_detection(
        self, hl7_case_id, existing_date, new_date
    ):
        """
    ...
    def test_property_gepado_clinical_validation_logging(
        self, hl7_case_id, output_date
    ):
        """
    ...
    def test_property_gepado_error_resilience(
        self, hl7_case_id, output_date, art_der_daten
    ):
        """
        ...
        **Validates: Requirements 3.9**
        ...
        try:
            ...
            vn_field, ibe_field, servicedate_field = map_data_type_to_fields(
                art_der_daten
            )
            expected_date_str = output_date.strftime("%Y-%m-%d")
            expected_updates = {
                vn_field: "VN123",
                ibe_field: "IBE123",
                servicedate_field: expected_date_str,
            }
            mock_client.update_record.assert_called_once_with(
                hl7_case_id, expected_updates
            )
...
class TestHL7CaseIdCorrectionIntegration:
    ...
    @patch("mvh_copy_mb.gepado.GepadoClient")
    def test_uses_corrected_case_id_for_gepado_operations(
        self, mock_client_class, mock_correction
    ):
        ...
        mock_client.update_record.assert_called_once_with(
            corrected_case_id, {"vng": "VN123", "ibe_g": "IBE123"}
        )

    @patch("mvh_copy_mb.hl7_case_id_correction.correct_hl7_case_id_for_gepado")
    @patch("mvh_copy_mb.gepado.GepadoClient")
    def test_uses_original_case_id_when_no_correction_needed(
        self, mock_client_class, mock_correction
    ):
        ...
        mock_client.update_record.assert_called_once_with(
            case_id, {"vng": "VN123", "ibe_g": "IBE123"}
        )

    @patch("mvh_copy_mb.hl7_case_id_correction.correct_hl7_case_id_for_gepado")
    @patch("mvh_copy_mb.gepado.GepadoClient")
    def test_handles_correction_system_errors_gracefully(
        self, mock_client_class, mock_correction
    ):
    ...
    @patch("mvh_copy_mb.hl7_case_id_correction.correct_hl7_case_id_for_gepado")
    @patch("mvh_copy_mb.gepado.GepadoClient")
    def test_backward_compatibility_with_existing_workflows(
        self, mock_client_class, mock_correction
    ):
        ...
        mock_client.query_record.assert_called_once_with(case_id)
        mock_client.update_record.assert_called_once_with(
            case_id, {"vng": "NEW_VNG", "ibe_g": "NEW_IBE_G"}
        )

    @patch("mvh_copy_mb.hl7_case_id_correction.correct_hl7_case_id_for_gepado")
    @patch("mvh_copy_mb.gepado.GepadoClient")
    def test_correction_with_leistungsdatum_integration(
        self, mock_client_class, mock_correction
    ):
        ...
        mock_record = GepadoRecord(
            hl7_case_id=corrected_case_id, vng=None, ibe_g=None, mv_servicedate_g=None
        )
        mock_client.query_record.return_value = mock_record
        mock_client.update_record.return_value = True
        ...
        mock_client.update_record.assert_called_once_with(
            corrected_case_id, expected_updates
        )

    @patch("mvh_copy_mb.hl7_case_id_correction.correct_hl7_case_id_for_gepado")
    @patch("mvh_copy_mb.gepado.GepadoClient")
    def test_correction_preserves_local_storage_case_id(
        self, mock_client_class, mock_correction
    ):
        ...
        try:
            ...
            mock_record = GepadoRecord(
                hl7_case_id=corrected_case_id, vng=None, ibe_g=None
            )
            mock_client.query_record.return_value = mock_record
            mock_client.update_record.return_value = True
            ...
            log_output = log_capture.getvalue()
            assert original_case_id in log_output, (
                "Original case ID should be preserved in logs"
            )
            assert corrected_case_id in log_output, (
                "Corrected case ID should be mentioned in logs"
            )
    ...
    def test_property_correction_system_integration(
        self,
        original_case_id,
        corrected_case_id,
        vorgangsnummer,
        ...
        **Validates: Requirements 4.1, 4.3**
        ...
        with patch(
            "mvh_copy_mb.hl7_case_id_correction.correct_hl7_case_id_for_gepado"
        ) as mock_correction:
            mock_client = Mock()
